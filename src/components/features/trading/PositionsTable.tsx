    ...
    switch (activeTab) {
          ...
          <>
            ...
            <TableBody>
              {positionsLoading ? (
                ...
                <TableRow>
                  <TableCell colSpan={7} className="text-center text-red-500">{positionsError.message}</TableCell>
                </TableRow>
              ) : positions.length === 0 ? (
                <TableRow>
      ...
      case 'trades':
        return (
          <TableBody>
            <TableRow>
              <TableCell colSpan={8} className="text-center">Trade history coming soon</TableCell>
            </TableRow>
          </TableBody>
        );
    }
